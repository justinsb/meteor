...
//    if (LocalCollection._useOID) {
//      doc._id = new LocalCollection._ObjectID(DDP.RandomStreams.makeMongoOid(self.name));
//    } else {
//      doc._id = DDP.RandomStreams.makeCollectionId(self.name);
//    }
